...
pub const VAR: c_int = 259;
pub const END: c_int = 260;
pub const PROGRAM_END: c_int = 261;
pub const enum_yytokentype = c_int;
pub const yytoken_kind_t = enum_yytokentype;
pub const union_YYSTYPE = extern union {
    num: f64,
    id: [*c]u8,
};
pub const YYSTYPE = union_YYSTYPE;
...
pub const YY_YY_PARSER_TAB_H_INCLUDED = "";
